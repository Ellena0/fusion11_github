...
<body>
    <div class="section">
        <div id="sec_title"><h2>고객섬김센터</h2></div>
            <div id="sec_subtitle">
                <ul>
                    <li><a href="Lecfly_CS_1.html"style="background-color: orange">1:1 문의</a></li>
                    <li><a href="Lecfly_CS_2.html">자주묻는 질문</a></li>
                    <li><a href="Lecfly_CS_3.html">공지사항</a></li>
                </ul>
            </div>
            
            <div class="1by1">
                <div id="box">실시간 상담</div>
                <div id="box">전화 상담</div>
                <div id="box">1:1 문의</div>
